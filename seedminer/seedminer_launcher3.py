...
def update_db():
    download("https://github.com/zoogie/nodes/blob/master/old-v2.dat?raw=true", "saves/old-v2.dat")
    download("https://github.com/zoogie/nodes/blob/master/new-v2.dat?raw=true", "saves/new-v2.dat")
